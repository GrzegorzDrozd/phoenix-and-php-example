...
if config_env() == :prod do
  database_host = System.get_env("DATABASE_HOST") || "database"
  database_name = System.get_env("POSTGRES_DB") || "phoenix_app_prod"
  database_user = System.get_env("POSTGRES_USER") || "postgres"
  database_password = System.get_env("POSTGRES_PASSWORD") || "postgres"

  database_url = "ecto://#{database_user}:#{database_password}@#{database_host}/#{database_name}"
