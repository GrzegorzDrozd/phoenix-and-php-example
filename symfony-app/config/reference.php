 ...
 * }
 * @psalm-type TablerConfig = array{
 *     options?: array{
 *         dark_mode?: bool|Param, // Default: false
 *         theme_auto?: bool|Param, // Default: false
 *         header_dark?: bool|Param, // Default: false
 *         navbar_dark?: bool|Param, // Default: false
 *         navbar_condensed?: bool|Param, // Default: true
 *         navbar_overlap?: bool|Param, // Default: false
 *         boxed_layout?: bool|Param, // Default: true
 *         rtl_mode?: bool|Param, // Default: false
 *         user_menu_condensed?: bool|Param, // Default: false
 *         logo_url?: scalar|null|Param, // Default: null
 *         security_cover_url?: scalar|null|Param, // Default: "https://placehold.co/1000"
 *         theme_base?: "slate"|"gray"|"zinc"|"neutral"|"stone"|Param, // Default: "gray"
 *         theme_radius?: 0|0.5|1|1.5|2|Param, // Default: 1
 *         theme_primary?: "blue"|"azure"|"indigo"|"purple"|"pink"|"red"|"orange"|"yellow"|"lime"|"green"|"teal"|"cyan"|Param, // Default: "blue"
 *     },
 *     knp_menu?: array{
 *         enable?: bool|Param, // Default: false
 *         main_menu?: scalar|null|Param, // your builder alias // Default: "tabler_main"
 *         breadcrumb_menu?: scalar|null|Param, // Your builder alias or false to disable breadcrumbs // Default: false
 *     },
 *     routes?: array{
 *         tabler_welcome?: scalar|null|Param, // name of the homepage route // Default: "home"
 *         tabler_login?: scalar|null|Param, // name of the form login route // Default: "login"
 *         tabler_logout?: scalar|null|Param, // Deprecated: The child node "tabler_logout" at path "tabler.routes.tabler_logout" is deprecated. // name of the logout route // Default: "logout"
 *         tabler_login_check?: scalar|null|Param, // name of the form login_check route // Default: "login_check"
 *         tabler_registration?: scalar|null|Param, // name of the user registration form route // Default: null
 *         tabler_registration_register?: scalar|null|Param, // name of the user registration form processing route // Default: null
 *         tabler_password_reset?: scalar|null|Param, // name of the forgot-password form route // Default: null
 *         tabler_password_reset_sent?: scalar|null|Param, // name of the sent forgot-password email form route // Default: null
 *     },
 *     icons?: list<scalar|null|Param>,
 * }
